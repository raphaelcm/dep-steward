 ...
 *
 * That path owes nothing to a third-party listing. A community-marketplace
 * submission is pending; it would add `@claude-community` as a second source,
 * so these invariants hold either way.
 *
